...
extern pid_handler_t pid_handler;
...
//options database
extern opt_odb_t *sim_odb;

//stats database
extern stat_sdb_t *sim_sdb;
...
void sim_load_prog(std::string fname, std::vector<std::string>argv, std::vector<std::string>envp);
